...
import { Post, Body, Controller, HttpCode, HttpStatus, HttpException, Get, Headers, UseGuards, Inject  } from '@nestjs/common';
...
export class AuthController {
  ...
  @Post('login')
    login(@Body() loginInfo: LoginDTO) {
      console.log("----")
        const retornoLogin = this.authService.login(loginInfo)
        return retornoLogin
    }
